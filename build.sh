...
cd "$SCRIPT_DIR/Appli" || { echo "Error: Appli directory not found"; exit 1; }
...
/Applications/ArmGNUToolchain/14.2.rel1/arm-none-eabi/bin/arm-none-eabi-objcopy -O binary Appli.elf Appli.bin
if [ $? -ne 0 ]; then
