...
void rgb_lcd_init(void)
{
	...
	HAL_GPIO_WritePin(GPIOF, RGB_LCD_INIT_SCK_PIN_Pin|RGB_LCD_INIT_SDA_PIN_Pin, GPIO_PIN_SET);
    /*Configure GPIO pins : PFPin PFPin PFPin */
    GPIO_InitStruct.Pin = RGB_LCD_INIT_SCK_PIN_Pin|RGB_LCD_INIT_SDA_PIN_Pin;
